...
import tk.lorddarthart.justdoitlist.view.main.home.todo.sort.SortFragment
...
@Component(modules = [AppModule::class, DataModule::class, FirebaseModule::class, RepositoryModule::class, RouterModule::class])
@Singleton
